...
namespace Framework.Network
{
    public class PacketHandler
    {
        ...
        private Action<Protocol.S_SET_FPS_TRANSFORM> S_SET_FPS_TRANSFORM_Handler;
        ...
        public PacketHandler()
        {
            ...
            Handlers.Add(203, _Handle_S_SET_FPS_TRANSFORM);
            Handlers.Add(205, _Handle_S_ATTACKED);
        }
        ...
        public void AddHandler( Action<Protocol.S_SET_FPS_TRANSFORM> handler )
        {
            S_SET_FPS_TRANSFORM_Handler += handler;
        }
        public void RemoveHandler( Action<Protocol.S_SET_FPS_TRANSFORM> handler )
        {
            S_SET_FPS_TRANSFORM_Handler -= handler;
        }
        private void _Handle_S_SET_FPS_TRANSFORM( IMessage message )
        {
            S_SET_FPS_TRANSFORM_Handler?.Invoke((Protocol.S_SET_FPS_TRANSFORM)message);
        }
